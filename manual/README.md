...
_DataStax_ provides full integration of the _Apache TinkerPop_ framework working over 
the _Cassandra Native Protocol_ when interacting with _DataStax Enterprise Graph_.
